{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e0666d57-17fb-41fb-9322-0f515893321a",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "e46f8920-0ae7-46e8-8a05-3506e0a362f6",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": " Ejemplo NE555 en configuración como ASTABLE con \n Dutty y frecuencia ajustables",
            "readonly": false
          },
          "position": {
            "x": 792,
        ...
        {
          "id": "6ccdacd6-6d34-4928-a1ef-55eda2b77996",
        ...
        {
          "id": "2963ceb2-89a8-426f-84ce-a2817cc9c7c2",
        ...
        {
          "id": "43c42bd5-9af8-4f92-8825-2ecaa8829d58",
          "type": "basic.info",
          "data": {
            "info": "Los dos corazones,\nel Mux y el contador\nUp-Down, equivaldrían\na la red de dos \nresistencias R1,R2\ny C.\ndonde la carga y descarga\nse realiza por distintos\ncaminos variando así\nla frecuencia y el Dutty\nde la señal de salida",
            "readonly": false
          },
          "position": {
            "x": -128,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "2963ceb2-89a8-426f-84ce-a2817cc9c7c2",
        ...
        {
          "source": {
            "block": "6ccdacd6-6d34-4928-a1ef-55eda2b77996",
        ...
        },
        {
          ...
          "target": {
            "block": "e0666d57-17fb-41fb-9322-0f515893321a",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "e46f8920-0ae7-46e8-8a05-3506e0a362f6",
            "port": "in"
          },
          "vertices": [
            {
