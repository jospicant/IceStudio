{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f02d66c5-0d00-4e63-b8d4-441063dd5846",
          "type": "basic.constant",
          "data": {
            "name": "Baud",
            "value": "9600",
        ...
        {
          "id": "34c061df-b938-4a04-9341-248025ef71d8",
          "type": "basic.constant",
          "data": {
            "name": "Dato",
            "value": "\"K\"",
        ...
        {
          "id": "ee893832-8ccd-4726-bab1-fe4cc797bc1a",
          "type": "basic.output",
          "data": {
            "name": "Dato",
            "range": "[7:0]",
        ...
        {
          "id": "7afebb75-ee9b-4c79-8e84-8425a738fcec",
        ...
        {
          "id": "d81e6e72-a8f8-4fe0-9357-5282b538fe23",
        ...
        {
          "id": "681ebd3f-ef57-495a-849a-b884718efc50",
          "type": "basic.constant",
          "data": {
            "name": "Segundos",
            "value": "1",
        ...
        {
          "id": "0c536318-c6dc-4d33-819f-8392d211a49b",
          "type": "basic.output",
          "data": {
            "name": "Ready",
            "pins": [
        ...
        {
          "id": "1a41ef7a-80ed-405f-97af-2cf8ea3e4192",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "7bcb2967-77a6-4838-88fd-606f3c72617a",
      ...
      "wires": [
        {
          "source": {
            "block": "f02d66c5-0d00-4e63-b8d4-441063dd5846",
            "port": "constant-out"
          },
          "target": {
        ...
        {
          "source": {
            "block": "7afebb75-ee9b-4c79-8e84-8425a738fcec",
        ...
        {
          "source": {
            "block": "34c061df-b938-4a04-9341-248025ef71d8",
            "port": "constant-out"
          },
          "target": {
            "block": "7afebb75-ee9b-4c79-8e84-8425a738fcec",
        ...
        {
          "source": {
            "block": "1a41ef7a-80ed-405f-97af-2cf8ea3e4192",
            "port": "out"
          },
          "target": {
            "block": "7bcb2967-77a6-4838-88fd-606f3c72617a",
            "port": "fabd9c4f-a3bf-43e1-86c1-be5bf602e9bf"
          }
        },
        {
          "source": {
            "block": "681ebd3f-ef57-495a-849a-b884718efc50",
            "port": "constant-out"
          },
          "target": {
            "block": "7bcb2967-77a6-4838-88fd-606f3c72617a",
        ...
        },
        {
          ...
          "target": {
            "block": "d81e6e72-a8f8-4fe0-9357-5282b538fe23",
        ...
        },
        {
          ...
          "target": {
            "block": "0c536318-c6dc-4d33-819f-8392d211a49b",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "ee893832-8ccd-4726-bab1-fe4cc797bc1a",
            "port": "in"
          },
          "size": 8
        }
