  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\nYou can configure differents Bauds.\nYou can use a terminal program as \"Tera Term ( Windows)\" to capture data send it to a terminal of you PC.\nThis example send a character \"2\" continuosly each second.\n",
            "readonly": false
          },
          "position": {
            "x": -56,
        ...
        {
          "id": "92173ded-2f75-4846-9c99-1d62e7fa1364",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "92173ded-2f75-4846-9c99-1d62e7fa1364",
