{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "77868b4f-9b6b-4912-917c-573790ff6477",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "20",
        ...
        {
          "id": "91550270-3049-47bb-ac16-a9693a3b4f87",
          "type": "basic.code",
          "data": {
            "code": "\nreg [4:0] d = 0;\n\nalways @(posedge clk)\nbegin\n    if(Reset)\n      d<=0;\n    else\n    begin\n     if(Enable)\n      d<=d+1;\n     else\n      d<=d;\n    end\nend",
            "params": [],
        ...
        {
          "id": "85ef189e-cc81-42e0-b6d0-fcd343ab1a6d",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "555df2b4-f940-4a45-aa74-4ab39942ea52",
        ...
        {
          "id": "3debf105-f28a-411f-8e40-763af101fb40",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[4:0]",
        ...
        {
          "id": "8d1fa4a5-813c-4980-bc43-506e9e023357",
        ...
        {
          "id": "f14cb9b3-a8bc-4894-8d0d-b9ee5d8da721",
        ...
        {
          "id": "97132b80-f9ba-4368-8ea6-26accbde5618",
        ...
        {
          "id": "414568f2-6ea6-49bb-8470-8a66240d3802",
        ...
        {
          "id": "678cc5cb-5db0-4637-b7b0-75f19679c0e2",
        ...
        {
          "id": "b7dbe87e-703a-4b6b-b20f-2fb496e9cb58",
        ...
        {
          "id": "3631c185-2e66-4e72-a441-c4c16375f4fa",
          "type": "70ff7f2a2f0ede80fc37c66a997650a1d0d0102b",
          "position": {
            "x": 616,
            "y": 304
        ...
        {
          "id": "cfe7af34-a5b3-4e04-9062-b45b10d0cba4",
      ...
      "wires": [
        {
          "source": {
            "block": "f14cb9b3-a8bc-4894-8d0d-b9ee5d8da721",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "97132b80-f9ba-4368-8ea6-26accbde5618",
            "port": "6855f64f-fa1c-4371-b2e1-a98970674a96"
          }
        },
        {
          "source": {
            "block": "b7dbe87e-703a-4b6b-b20f-2fb496e9cb58",
        ...
        },
        {
          ...
          "target": {
            "block": "3631c185-2e66-4e72-a441-c4c16375f4fa",
            "port": "6855f64f-fa1c-4371-b2e1-a98970674a96"
          }
        },
        {
          "source": {
            "block": "414568f2-6ea6-49bb-8470-8a66240d3802",
        ...
        {
          "source": {
            "block": "cfe7af34-a5b3-4e04-9062-b45b10d0cba4",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "3631c185-2e66-4e72-a441-c4c16375f4fa",
        ...
        {
          "source": {
            "block": "91550270-3049-47bb-ac16-a9693a3b4f87",
            "port": "d"
          },
          "target": {
            "block": "3debf105-f28a-411f-8e40-763af101fb40",
            "port": "in"
          },
          "size": 5
        },
        {
          ...
          "target": {
            "block": "678cc5cb-5db0-4637-b7b0-75f19679c0e2",
        ...
        {
          "source": {
            "block": "8d1fa4a5-813c-4980-bc43-506e9e023357",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "91550270-3049-47bb-ac16-a9693a3b4f87",
        ...
        {
          "source": {
            "block": "555df2b4-f940-4a45-aa74-4ab39942ea52",
        ...
        {
          "source": {
            "block": "85ef189e-cc81-42e0-b6d0-fcd343ab1a6d",
            "port": "out"
          },
          "target": {
            "block": "555df2b4-f940-4a45-aa74-4ab39942ea52",
        ...
        {
          "source": {
            "block": "77868b4f-9b6b-4912-917c-573790ff6477",
            "port": "constant-out"
          },
          "target": {
            "block": "555df2b4-f940-4a45-aa74-4ab39942ea52",
