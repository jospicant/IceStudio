    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n51200 Hz para conseguir con\n10 bits un periodo de pwm de\n20 ms ( on reloj de 12 MHZ ).\n\nsi quisiera con esos 10 bits conseguir\notro periodo de pwm tendría que calcular\nel nuevo valor en Hz.También se deberían\nre-calcular los valores min y maximo para\nel rango de 0 a 180 grados.\nvalor desde y min deben ser iguales",
            "readonly": true
          },
          "position": {
            "x": 936,
        ...
        {
          "id": "a3dd468a-b4d0-45ea-a102-61e4fd46492b",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a3dd468a-b4d0-45ea-a102-61e4fd46492b",
