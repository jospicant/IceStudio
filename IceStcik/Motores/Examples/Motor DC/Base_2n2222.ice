{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "40e7d799-b730-4995-bb28-a0b8c28983fd",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "ecb5fe17-b085-48ea-8592-fbe91ee737ce",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "bc83f576-4d0e-486d-aa81-2be9f3ae779c",
          "type": "basic.output",
          "data": {
            "name": "Base_2n222",
            "pins": [
        ...
        {
          "id": "96df23be-ae4c-4f7a-b833-020e7cb4a571",
          "type": "basic.constant",
          "data": {
            "name": "t",
            "value": "20",
        ...
        {
          "id": "9a7d13c5-29a8-4afe-a393-9c796598ec53",
      ...
      "wires": [
        {
          "source": {
            "block": "96df23be-ae4c-4f7a-b833-020e7cb4a571",
            "port": "constant-out"
          },
          "target": {
            "block": "9a7d13c5-29a8-4afe-a393-9c796598ec53",
            "port": "63eb4dd8-1e63-4a4f-8ec8-f5d8f49c1087"
          }
        },
        {
          "source": {
            "block": "ecb5fe17-b085-48ea-8592-fbe91ee737ce",
            "port": "out"
          },
          "target": {
            "block": "9a7d13c5-29a8-4afe-a393-9c796598ec53",
        ...
        },
        {
          ...
          "target": {
            "block": "bc83f576-4d0e-486d-aa81-2be9f3ae779c",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "40e7d799-b730-4995-bb28-a0b8c28983fd",
            "port": "in"
          }
        }
      ]
