{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "d7e199ad-ff83-467b-ad66-65aa03089747",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "3c6adf61-a681-4cf9-97ca-b89b5eee2184",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "9b9bc498-b8f7-4488-a602-0534b5af14c7",
          "type": "basic.output",
          "data": {
            "name": "Step",
            "pins": [
        ...
        {
          "id": "b772e655-c46a-49a6-ba29-9bb35c03eb1d",
          "type": "basic.constant",
          "data": {
            "name": "Speed",
            "value": "200",
        ...
        {
          "id": "b944db81-4d5d-402e-9fdb-01ee7c592363",
      ...
      "wires": [
        {
          "source": {
            "block": "b772e655-c46a-49a6-ba29-9bb35c03eb1d",
            "port": "constant-out"
          },
          "target": {
            "block": "b944db81-4d5d-402e-9fdb-01ee7c592363",
            "port": "63eb4dd8-1e63-4a4f-8ec8-f5d8f49c1087"
          }
        },
        {
          "source": {
            "block": "3c6adf61-a681-4cf9-97ca-b89b5eee2184",
            "port": "out"
          },
          "target": {
            "block": "b944db81-4d5d-402e-9fdb-01ee7c592363",
        ...
        },
        {
          ...
          "target": {
            "block": "9b9bc498-b8f7-4488-a602-0534b5af14c7",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d7e199ad-ff83-467b-ad66-65aa03089747",
            "port": "in"
          },
          "vertices": [
            {
