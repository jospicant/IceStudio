{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e0b4c4f3-afcc-4234-8f3b-edbc8ff4373d",
          "type": "basic.output",
          "data": {
            "name": "Motor",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "HALF STEP MODE:\n\nUsando ULN2003 y un motor Unipolar de\n5 hilos 28BJY-48, giraremos en un sentido\ndurante 10 sg y en el otro durante otros\n10 sg.\n\nEn HALF STEP MODE:\n\n28BJY-48 a 5V consume 150mA y 300mA. Consumo\nmedio de 250mA.\nya que para conseguir medios pasos unas veces\nexcita 1 bobina y otras excita 2 bobinas.\nComo se mueve a medios pasos avanza la mitad\nque cuando se mueve a pasos enteros.\n",
            "readonly": true
          },
          "position": {
            "x": 720,
        ...
        {
          "id": "d13addde-c7ca-437f-a08c-66d41b30ea50",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "d13addde-c7ca-437f-a08c-66d41b30ea50",
            "port": "cda81d01-0279-44f8-a1dc-e02cb6398e80"
          },
          "target": {
            "block": "e0b4c4f3-afcc-4234-8f3b-edbc8ff4373d",
            "port": "in"
          },
          "size": 4
        },
