{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "bca33668-1741-4f60-a98f-ecf0d5488a40",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[11:0]",
        ...
        {
          "id": "13749488-892e-4093-a20c-3fc4d12af98e",
          "type": "basic.constant",
          "data": {
            "name": "datosROM",
            "value": "\"prog.list\"",
        ...
        {
          "id": "cfed3e93-4aac-4089-812b-d5b79d8275ab",
        ...
        {
          "id": "0193e7e0-bb86-478a-8919-cdb70ec4775e",
        ...
        {
          "id": "ce4b860e-3efc-4f98-a425-3adc6469ba48",
          "type": "19bb5e1fc676285e0f9984d674bd6710652a08a0",
          "position": {
            "x": 584,
            "y": 216
          },
      ...
      "wires": [
        {
          "source": {
            "block": "13749488-892e-4093-a20c-3fc4d12af98e",
            "port": "constant-out"
          },
          "target": {
            "block": "ce4b860e-3efc-4f98-a425-3adc6469ba48",
            "port": "9413ebb1-3547-4d05-bf97-d95547a78a4b"
          }
        },
        {
          "source": {
            "block": "cfed3e93-4aac-4089-812b-d5b79d8275ab",
        ...
        {
          "source": {
            "block": "0193e7e0-bb86-478a-8919-cdb70ec4775e",
            "port": "dbc69f51-e494-4c5d-9c0a-be78b68510e3"
          },
          "target": {
            "block": "ce4b860e-3efc-4f98-a425-3adc6469ba48",
            "port": "74373da5-46fc-4263-b7a7-c39117f2c9fe"
          },
          "size": 8
        },
        {
        ...
        },
        {
          "source": {
            "block": "ce4b860e-3efc-4f98-a425-3adc6469ba48",
            "port": "69a641b0-af09-49a6-bfd6-25db8bc0b268"
          },
          "target": {
            "block": "bca33668-1741-4f60-a98f-ecf0d5488a40",
            "port": "in"
          },
          "size": 12
        }
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "69a641b0-af09-49a6-bfd6-25db8bc0b268",
              "type": "basic.output",
              "data": {
                "name": "data",
                "range": "[11:0]",
            ...
            {
              "id": "74373da5-46fc-4263-b7a7-c39117f2c9fe",
              "type": "basic.input",
              "data": {
                "name": "addr",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "69a641b0-af09-49a6-bfd6-25db8bc0b268",
                "port": "in"
              },
              "size": 12
            },
            {
              "source": {
                "block": "74373da5-46fc-4263-b7a7-c39117f2c9fe",
                "port": "out"
              },
              "target": {
                "block": "8465b778-c230-4d9d-be4f-fd64160b17f9",
