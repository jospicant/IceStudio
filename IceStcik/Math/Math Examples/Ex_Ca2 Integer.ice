    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n El integer trabaja con 32 bits y en Ca2\n por lo que asignar a=-156  a = Ca2(156) = 100 en decimal = carácter \"d\"\n \n Conclusión: Integer trabaja en Ca2\n El complemento a 2 se usa para números negativos y rellenar por la izq de 1's hasta\n completar el número de bits con los que trabaja.\n \n \n ",
            "readonly": false
          },
          "position": {
            "x": 80,
        ...
        {
          "id": "c0d348c3-3bcd-487f-ae42-4c8611c3c1c8",
          "type": "basic.code",
          "data": {
            "code": "\ninteger a=-156;\n\nassign n=a;\n",
            "params": [],
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c0d348c3-3bcd-487f-ae42-4c8611c3c1c8",
            "port": "n"
          },
          "target": {
            "block": "3f1ea4b2-283a-4116-88e9-30bba3c5d999",
