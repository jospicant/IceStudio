{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "82c2285a-e5d1-4e12-8c3e-d424b9e035c4",
          "type": "basic.output",
          "data": {
            "name": "Tx",
            "pins": [
        ...
        {
          "id": "923f868d-566c-45fe-8ad8-6b6407e2a958",
          "type": "basic.constant",
          "data": {
            "name": "N1",
            "value": "-65",
        ...
        {
          "id": "05b65571-6134-4101-810f-20428de3053f",
          "type": "basic.constant",
          "data": {
            "name": "N2",
            "value": "-131",
        ...
        {
          "id": "df25fc4f-80c4-4235-8bb9-f873aee14ece",
          "type": "basic.constant",
          "data": {
            "name": "Baud",
            "value": "9600",
        ...
        {
          "id": "3ba01827-3904-4724-a1e9-4860a1dad265",
        ...
        {
          "id": "baf246ff-ccc5-45eb-9e53-febf7f9311cd",
        ...
        {
          "id": "180fc08d-1cc7-4c4a-87d7-87ea33e78a82",
        ...
        {
          "id": "4c39c149-2abd-4a19-84bd-9f74c852d66a",
          "type": "45aff3cfbc3e100974c409406d5ff6b0ec0ee288",
          "position": {
            "x": 64,
            "y": 304
        ...
        {
          "id": "3094a3df-b560-4613-9e5d-036b9b3729ff",
        ...
        {
          "id": "0d2c0bcf-73fd-48a4-999c-f0dd15b8fe9f",
          "type": "basic.info",
          "data": {
            "info": "\n68-3 = 65     --> caracter A\n63-(-4) = 67  --> caracter C\n-65-(-131)=66 --> caracter B",
            "readonly": false
          },
          "position": {
            "x": 296,
      ...
      "wires": [
        {
          "source": {
            "block": "baf246ff-ccc5-45eb-9e53-febf7f9311cd",
            "port": "c4f5acfe-a4e0-4afd-9175-bda8aac660f3"
          },
          "target": {
            "block": "3ba01827-3904-4724-a1e9-4860a1dad265",
        ...
        },
        {
          ...
          "target": {
            "block": "82c2285a-e5d1-4e12-8c3e-d424b9e035c4",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "df25fc4f-80c4-4235-8bb9-f873aee14ece",
            "port": "constant-out"
          },
          "target": {
            "block": "3ba01827-3904-4724-a1e9-4860a1dad265",
        ...
        {
          "source": {
            "block": "923f868d-566c-45fe-8ad8-6b6407e2a958",
            "port": "constant-out"
          },
          "target": {
            "block": "180fc08d-1cc7-4c4a-87d7-87ea33e78a82",
        ...
        {
          "source": {
            "block": "4c39c149-2abd-4a19-84bd-9f74c852d66a",
            "port": "1bd6eda7-e02f-4b2d-9d8c-e3c1c40111b5"
          },
          "target": {
            "block": "baf246ff-ccc5-45eb-9e53-febf7f9311cd",
        ...
        {
          "source": {
            "block": "05b65571-6134-4101-810f-20428de3053f",
            "port": "constant-out"
          },
          "target": {
            "block": "4c39c149-2abd-4a19-84bd-9f74c852d66a",
        ...
        {
          "source": {
            "block": "3094a3df-b560-4613-9e5d-036b9b3729ff",
