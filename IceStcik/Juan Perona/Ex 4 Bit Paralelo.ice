{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "0cac957a-f3d1-4d0a-a1c1-dc83243a5cc1",
          "type": "basic.constant",
          "data": {
            "name": "num",
            "value": "8",
        ...
        {
          "id": "6a90d2fb-0ff8-4111-8927-3d1a0f20a609",
          "type": "basic.output",
          "data": {
            "name": "D",
            "pins": [
        ...
        {
          "id": "c3fc7378-2ea6-4666-b296-1bae7c0f1d0e",
        ...
        {
          "id": "8cc524e4-13fb-4c81-be5e-051714c970ae",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "b40e9031-a89a-4912-9981-c973bb30a5bc",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "54dc1398-1289-41f4-888a-4e68229d9b00",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "0cac957a-f3d1-4d0a-a1c1-dc83243a5cc1",
            "port": "constant-out"
          },
          "target": {
            "block": "c3fc7378-2ea6-4666-b296-1bae7c0f1d0e",
        ...
        },
        {
          ...
          "target": {
            "block": "6a90d2fb-0ff8-4111-8927-3d1a0f20a609",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "8cc524e4-13fb-4c81-be5e-051714c970ae",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b40e9031-a89a-4912-9981-c973bb30a5bc",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "54dc1398-1289-41f4-888a-4e68229d9b00",
            "port": "in"
          },
          "vertices": [
            {
