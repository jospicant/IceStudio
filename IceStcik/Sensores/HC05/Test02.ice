{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "0b4c05de-68ac-481f-b4e7-f005b27ca25d",
          "type": "basic.output",
          "data": {
            "name": "D4",
            "pins": [
        ...
        {
          "id": "5f7e51aa-2c3d-4add-87d2-40d4eef480a7",
          "type": "basic.output",
          "data": {
            "name": "D3",
            "pins": [
        ...
        {
          "id": "48979971-4055-4c15-ab5b-61d04b14f4ea",
          "type": "basic.output",
          "data": {
            "name": "D2",
            "pins": [
        ...
        {
          "id": "3da00742-c2c0-440a-8ed5-3f1f87c96e6b",
          "type": "basic.output",
          "data": {
            "name": "D1",
            "pins": [
        ...
        {
          "id": "6ed31aa9-c334-41ac-94a3-d4b6828ba10e",
        ...
        {
          "id": "1cbadb1b-ed1f-493b-9dde-1ed0077b65af",
          "type": "basic.info",
          "data": {
            "info": "Status: OK",
            "readonly": false
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "\nreg[3:0] out=0;\n\n// Detecta pulsaciones de la letra\n// A,B,C y D\n\nalways @(*)\nbegin\n  case(data)\n        8'b01000001: out =4'b0001;\n        8'b01000010: out =4'b0010;\n        8'b01000011: out =4'b0100;\n        8'b01000100: out =4'b1000;\n        default: out=0;\n  endcase\nend\n",
            "params": [],
            "ports": {
              "in": [
                {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "6ed31aa9-c334-41ac-94a3-d4b6828ba10e",
        ...
        },
        {
          ...
          "target": {
            "block": "0b4c05de-68ac-481f-b4e7-f005b27ca25d",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "5f7e51aa-2c3d-4add-87d2-40d4eef480a7",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "48979971-4055-4c15-ab5b-61d04b14f4ea",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "3da00742-c2c0-440a-8ed5-3f1f87c96e6b",
            "port": "in"
          },
          "vertices": [
            {
