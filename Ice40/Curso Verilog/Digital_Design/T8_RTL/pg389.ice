{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "82b4b3b4-83cc-45ef-8590-b2073327c4b8",
          "type": "basic.output",
          "data": {
            "name": "D",
            "range": "[3:0]",
        ...
        {
          "id": "78657d20-f530-4340-9b54-86cec6dedd04",
          "type": "basic.output",
          "data": {
            "name": "d5",
            "pins": [
        ...
        {
          "id": "542683d0-1382-4551-aa53-842d9431d277",
          "type": "basic.constant",
          "data": {
            "name": "inicio",
            "value": "10",
        ...
        {
          "id": "0c850a2b-600c-4329-bd9e-2906d893bd93",
          "type": "basic.constant",
          "data": {
            "name": "Fin",
            "value": "11",
        ...
        {
          "id": "c111dfec-7aa3-46f3-a760-a427bfc32f28",
          "type": "basic.code",
          "data": {
            "code": "\nassign Load= ~x & T1;",
            "params": [],
        ...
        {
          "id": "a8ea3c19-ea93-44f6-8a54-cf4211b5cfd6",
          "type": "basic.info",
          "data": {
            "info": "**CONTROL x'T1**\n",
            "readonly": true
        ...
        {
          "id": "506a0049-273d-4810-80cd-2c1a8f7d556c",
          "type": "basic.info",
          "data": {
            "info": " **Transferencia de Registros A<--B **",
            "readonly": true
          },
          "position": {
            "x": 608,
        ...
        {
          "id": "f0c99bd2-ae1a-4467-89d9-ff2cdce07bfa",
        ...
        {
          "id": "3184a89e-8fca-43c3-a9a0-bb8fe8d6fe93",
        ...
        {
          "id": "b9331073-37b9-4b27-8223-4724d6b3ca7d",
        ...
        {
          "id": "ab00feb8-cfe2-4ab8-9d7a-a4c49f558a34",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": -208,
            "y": 408
        ...
        {
          "id": "822865a9-7ea5-4cf9-8bb5-21a8ac93c5f3",
          "type": "basic.code",
          "data": {
            "code": "\nreg[3:0] B=4'b1010;\nreg[3:0] A=4'b0001;\n\nassign out=A;\n\nalways @(posedge clk)\nbegin\n if(Load)\n   A=B;\n else A=A;\nend\n\n",
            "params": [],
        ...
        {
          "id": "4da32d64-7ce8-44f3-9f53-bd0098d7ade9",
          "type": "basic.info",
          "data": {
            "info": "\n Implementación HW  de  RTL ( Register Transfer Logic )  \n \n    señales de control: Transferencia de registros  \n   \n      x'T1:  A <-- B   ",
            "readonly": true
          },
          "position": {
            "x": 216,
      ...
      "wires": [
        {
          "source": {
            "block": "822865a9-7ea5-4cf9-8bb5-21a8ac93c5f3",
            "port": "out"
          },
          "target": {
            "block": "82b4b3b4-83cc-45ef-8590-b2073327c4b8",
            "port": "in"
          },
          "size": 4
        },
        {
          "source": {
            "block": "c111dfec-7aa3-46f3-a760-a427bfc32f28",
            "port": "Load"
          },
          "target": {
            "block": "822865a9-7ea5-4cf9-8bb5-21a8ac93c5f3",
        ...
        {
          "source": {
            "block": "f0c99bd2-ae1a-4467-89d9-ff2cdce07bfa",
        ...
        {
          "source": {
            "block": "3184a89e-8fca-43c3-a9a0-bb8fe8d6fe93",
        ...
        {
          "source": {
            "block": "b9331073-37b9-4b27-8223-4724d6b3ca7d",
        ...
        {
          "source": {
            "block": "542683d0-1382-4551-aa53-842d9431d277",
            "port": "constant-out"
          },
          "target": {
            "block": "3184a89e-8fca-43c3-a9a0-bb8fe8d6fe93",
        ...
        {
          "source": {
            "block": "0c850a2b-600c-4329-bd9e-2906d893bd93",
            "port": "constant-out"
          },
          "target": {
            "block": "3184a89e-8fca-43c3-a9a0-bb8fe8d6fe93",
        ...
        {
          "source": {
            "block": "ab00feb8-cfe2-4ab8-9d7a-a4c49f558a34",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "3184a89e-8fca-43c3-a9a0-bb8fe8d6fe93",
        ...
        },
        {
          ...
          "target": {
            "block": "78657d20-f530-4340-9b54-86cec6dedd04",
            "port": "in"
          },
          "vertices": [
            {
