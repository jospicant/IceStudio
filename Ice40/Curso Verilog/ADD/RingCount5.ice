{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "049a417b-9b07-4fea-8c26-819397dfb34b",
          "type": "basic.output",
          "data": {
            "name": "D",
            "range": "[4:0]",
        ...
        {
          "id": "c093355b-1baf-4b08-9d19-46103c25b8cd",
          "type": "basic.code",
          "data": {
            "code": "\nparameter N=5; //longitug del contador\nreg[4:0]data=5'b00001;\n\n\nalways @(posedge clk,posedge reset)\nif(reset) data<={{(N-1){1'b0}},1'b1}; // 4 ceros y 1 uno . 00001\nelse if(en)data<={data[N-2:0],data[N-1] }; //data[3:0],data[4]\n                                           //desplazamiento a drcha\n\nassign out[4:0]=data;",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "3ce7cfb9-6df0-4930-8e68-233b50223ced",
        ...
        {
          "id": "e1b6520a-04f8-4ee7-898d-738e52338ac9",
        ...
        {
          "id": "7f37f5f4-e746-4fee-9c3e-d4562c3c8944",
        ...
        {
          "id": "b9452897-07ce-40be-9354-56f7875691c7",
          "type": "basic.info",
          "data": {
            "info": "\n**Status: Checked OK**\n\n**Contador en anillo.**\nSe introduce un 1 que se irá desplazando en cada ciclo de reloj. (pg202)\n",
            "readonly": true
          },
          "position": {
            "x": 312,
      ...
      "wires": [
        {
          "source": {
            "block": "3ce7cfb9-6df0-4930-8e68-233b50223ced",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "c093355b-1baf-4b08-9d19-46103c25b8cd",
            "port": "reset"
          }
        },
        {
          "source": {
            "block": "e1b6520a-04f8-4ee7-898d-738e52338ac9",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "c093355b-1baf-4b08-9d19-46103c25b8cd",
        ...
        {
          "source": {
            "block": "7f37f5f4-e746-4fee-9c3e-d4562c3c8944",
        ...
        },
        {
          ...
          "target": {
            "block": "049a417b-9b07-4fea-8c26-819397dfb34b",
            "port": "in"
          },
          "size": 5
        }
