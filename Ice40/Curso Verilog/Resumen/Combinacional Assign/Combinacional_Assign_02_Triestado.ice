    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "//Triestado. mediante la señal \"sel\" se elige que señal\n// bloquear o no bloquear la señal de entrada \n\n// Si  sel = 1  out = in\n// Si  sel = 0  out = 1'bz  => Alta impedancia\n\nassign out= sel ? in : 1'bz ;\n\n",
            "params": [],
            "ports": {
              "in": [
                {
