{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "abcf3f3e-89d3-458a-a1ab-785bdd9b2950",
          "type": "basic.output",
          "data": {
            "name": "Lamp",
            "pins": [
        ...
        {
          "id": "72ee934d-535f-4bd8-a6dc-f4e39f24975b",
          "type": "basic.output",
          "data": {
            "name": "D1",
            "pins": [
        ...
        {
          "id": "dd412712-b27e-43d3-88cd-56db41442333",
          "type": "basic.constant",
          "data": {
            "name": "T_sg",
            "value": "8",
        ...
        {
          "id": "34c3cdb4-4fe2-4487-8640-ad68333156b5",
        ...
        {
          "id": "5336f087-9144-4061-ad7c-1bdd9bc50fe2",
          "type": "basic.info",
          "data": {
            "info": " **Salida a Relé de estado Sólido  \n SSR D2425.**\n ",
            "readonly": true
          },
          "position": {
            "x": 720,
        ...
        {
          "id": "6befa085-d6be-42e7-a8d9-9459cdcb9763",
          "type": "basic.info",
          "data": {
            "info": "# Dando potencia a tu FPGA",
            "readonly": true
          },
          "position": {
            "x": 384,
      ...
      "wires": [
        {
          "source": {
            "block": "dd412712-b27e-43d3-88cd-56db41442333",
            "port": "constant-out"
          },
          "target": {
            "block": "34c3cdb4-4fe2-4487-8640-ad68333156b5",
        ...
        },
        {
          ...
          "target": {
            "block": "abcf3f3e-89d3-458a-a1ab-785bdd9b2950",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "72ee934d-535f-4bd8-a6dc-f4e39f24975b",
            "port": "in"
          }
        }
      ]
