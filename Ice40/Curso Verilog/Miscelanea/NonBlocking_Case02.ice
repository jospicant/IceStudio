{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ccb5dd1f-b2dd-44ae-9232-7d8f0d50da70",
          "type": "basic.output",
          "data": {
            "name": "D4",
            "pins": [
        ...
        {
          "id": "941a4087-e14b-4022-84f3-22e807cc8575",
          "type": "basic.output",
          "data": {
            "name": "D3",
            "pins": [
        ...
        {
          "id": "61099599-30c3-490f-83f1-ec4b01b6e166",
          "type": "basic.output",
          "data": {
            "name": "D2",
            "pins": [
        ...
        {
          "id": "dea8421f-8a60-450b-ab31-83e4759d3470",
          "type": "basic.output",
          "data": {
            "name": "D1",
            "pins": [
        ...
        {
          "id": "80bbb22e-1511-499e-9459-b16ca04e664a",
        ...
        {
          "id": "0e24f162-abcb-41fe-aa32-9c3cdf0fde13",
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "\n\nreg[3:0] b=0;\n\nalways @(posedge clk) begin\n \n //Valores por defecto justo despues del always\n b<=15;  //equivale a default: b<=15\n \n    case(a)\n       0:b<=0;\n       1:b<=1;\n       2:b<=2;\n       3:b<=3;\n       4:b<=4;\n       5:b<=5;\n       6:b<=6;\n       7:b<=7;\n    endcase\nend\n\nassign {o4,o3,o2,o1}=b;\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "b36196c3-1b6b-4dff-9a40-aa65a15d2414",
      ...
      "wires": [
        {
          "source": {
            "block": "80bbb22e-1511-499e-9459-b16ca04e664a",
            "port": "c138a610-b61f-4e7c-bb8a-c4f3b0b9f95c"
          },
          "target": {
            "block": "b36196c3-1b6b-4dff-9a40-aa65a15d2414",
            "port": "26aba23f-8567-4e9b-bd45-c26724030f33"
          }
        },
        {
          "source": {
            "block": "0e24f162-abcb-41fe-aa32-9c3cdf0fde13",
        ...
        },
        {
          ...
          "target": {
            "block": "941a4087-e14b-4022-84f3-22e807cc8575",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "61099599-30c3-490f-83f1-ec4b01b6e166",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "dea8421f-8a60-450b-ab31-83e4759d3470",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "ccb5dd1f-b2dd-44ae-9232-7d8f0d50da70",
            "port": "in"
          }
        },
        {
