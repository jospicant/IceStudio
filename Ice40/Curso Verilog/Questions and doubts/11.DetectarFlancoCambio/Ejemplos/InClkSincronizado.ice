{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "84fb862b-7839-4077-a89c-0f99b470918a",
          "type": "basic.output",
          "data": {
            "name": "in",
            "pins": [
        ...
        {
          "id": "2909e6db-8329-4e63-b288-3a7823dd53d0",
          "type": "basic.constant",
          "data": {
            "name": "ms",
            "value": "1000",
        ...
        {
          "id": "fd3a4ea4-5e8e-4dc5-85d1-f373f89d42fb",
          "type": "basic.constant",
          "data": {
            "name": "ms",
            "value": "125",
        ...
        {
          "id": "11aadaf9-5ca1-4902-82d3-114738e28ba5",
        ...
        {
          "id": "ff68754b-ece9-4b55-a43b-6653f7151120",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Status: Tested OK \n\nEn este ejemplo la señal de entrada es una señal que está sincronizada con el reloj del sistema por lo que nuestro módulo de geheración de \"tics\" por flanco/Cambio de nivel  \nfuncionará perfectamente y se producirán los \"tics\" correspondientes (Toggle,Rising,Falling) con ancho = periodo del reloj del sistema (12Mhz).  \nPor \"in\" nos entra un reloj de periodo 1 sg ( sincronizado con el reloj del sistema de 12Mhz) y el contador tiene un reloj de 125ms por lo que los 500 ms que estará a nivel alto la entrada  \nel reloj podrá contar 4 pulsos y durante los 500ms que la entrada estará a nivel baja como \"Enable\" estará desactivado, el contador estará parado.  \nVeremos pues que el contador cuenta 4 para, cuenta otros 4, para y cuenta otros 4 ... Todo esto es gracias a que en la salida \"T\" se produce un \"tic\" en cada cambio de nivel detectado en la   \nentrada haciendo que el biestable T nos acive/desactive la señal Enable del contador. \n\n",
            "readonly": true
          },
          "position": {
            "x": -376,
        ...
        {
          "id": "bdd6becb-f689-4d2d-a148-6c8eb60985d9",
        ...
        {
          "id": "ed854db6-12e3-4cf9-a836-0072ed060114",
          "type": "5b13418bc26ccebd737be20d8a57a9a5aae9dc92",
          "position": {
            "x": 616,
            "y": 96
        ...
        {
          "id": "1875ba5a-d5e7-48fd-94c9-c4c852dab82d",
          "type": "basic.info",
          "data": {
            "info": "Toggle",
            "readonly": true
        ...
        {
          "id": "3da9d8ad-07d8-40a3-abf2-10547af4c1db",
          "type": "basic.info",
          "data": {
            "info": "Falling",
            "readonly": true
        ...
        {
          "id": "175e4510-c7cf-4651-b433-d62c51866699",
          "type": "basic.info",
          "data": {
            "info": "Rising",
            "readonly": true
        ...
        {
          "id": "b7728ae3-916e-4fb3-92da-203dd90fd21c",
          "type": "basic.info",
          "data": {
            "info": "clk 12Mhz",
            "readonly": true
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "ff68754b-ece9-4b55-a43b-6653f7151120",
        ...
        {
          "source": {
            "block": "475f35c7-5eff-4617-ac0c-5314d104e00e",
        ...
        {
          "source": {
            "block": "bdd6becb-f689-4d2d-a148-6c8eb60985d9",
        ...
        {
          "source": {
            "block": "2909e6db-8329-4e63-b288-3a7823dd53d0",
            "port": "constant-out"
          },
          "target": {
            "block": "bdd6becb-f689-4d2d-a148-6c8eb60985d9",
        ...
        {
          "source": {
            "block": "ed854db6-12e3-4cf9-a836-0072ed060114",
            "port": "3fca0749-ce9d-42c5-98cb-aa24163d4324"
          },
          "target": {
            "block": "c5120156-4ce5-4455-89cc-ca8a9ee43abd",
        ...
        {
          "source": {
            "block": "fd3a4ea4-5e8e-4dc5-85d1-f373f89d42fb",
            "port": "constant-out"
          },
          "target": {
            "block": "ed854db6-12e3-4cf9-a836-0072ed060114",
        ...
        },
        {
          ...
          "target": {
            "block": "84fb862b-7839-4077-a89c-0f99b470918a",
            "port": "in"
          }
        }
      ]
