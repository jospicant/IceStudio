    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Status: Tested OK \n\nEn este ejemplo la señal de entrada es una señal que está sincronizad con el reloj del sistema por lo que nuestro módulo de geheración de \"tics\" por flanco/Cambio de nivel  \nfuncionará perfectamente.",
            "readonly": true
          },
          "position": {
            "x": -360,
