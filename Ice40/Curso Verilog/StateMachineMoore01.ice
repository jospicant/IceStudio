{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "04e9e08a-4d4e-45cd-978e-d959fb9da882",
          "type": "basic.constant",
          "data": {
            "name": "t_start",
            "value": "10",
        ...
        {
          "id": "027d311c-f8a6-4a4f-995c-e6d211ae9490",
          "type": "basic.code",
          "data": {
            "code": "\nreg out;\nreg [1:0] state ; // States\n\nlocalparam[1:0] state_A=0,state_B=1,state_C=2; //Three different states\n\nalways @(posedge clk or posedge reset)\nbegin\n if(reset)\n  state <= state_A;\n else\n    /*Define Next States using a Case*/\n   case(state)\n     state_A:\n        if(input1==0)\n           state <=state_B;\n        else\n           state <=state_C;\n     state_B:\n        state <= state_C;\n     state_C:\n        if(input2)\n           state <=state_A;\n        else\n           state <=state_C;\n     default:\n           state <=state_A;\n   endcase\nend\n    \nalways @(state)  //We define output\nbegin\n  case(state)\n    state_A:out<=0;\n    state_B:out<=1;\n    state_C:out<=0;\n    default: out<=0;\n  endcase\nend\n\n\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "0f66f36a-d36a-4e2b-83e3-abbfdcf217bb",
        ...
        {
          "id": "284b6665-797f-4ca6-9f63-aa0386a8520c",
        ...
        {
          "id": "f938d2bc-1098-46ca-ad18-497ff0bdc525",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "67329754-d409-405a-80db-4f5500e5ec1b",
        ...
        {
          "id": "828fddc7-5e7e-48a6-91e3-18d9df64c019",
        ...
        {
          "id": "85d73da5-2f9f-472d-8f41-4ce39a59fbde",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "027d311c-f8a6-4a4f-995c-e6d211ae9490",
            "port": "out"
          },
          "target": {
            "block": "f938d2bc-1098-46ca-ad18-497ff0bdc525",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "828fddc7-5e7e-48a6-91e3-18d9df64c019",
        ...
        {
          "source": {
            "block": "0f66f36a-d36a-4e2b-83e3-abbfdcf217bb",
        ...
        {
          "source": {
            "block": "04e9e08a-4d4e-45cd-978e-d959fb9da882",
            "port": "constant-out"
          },
          "target": {
            "block": "0f66f36a-d36a-4e2b-83e3-abbfdcf217bb",
        ...
        },
        {
          ...
          "target": {
            "block": "85d73da5-2f9f-472d-8f41-4ce39a59fbde",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "284b6665-797f-4ca6-9f63-aa0386a8520c",
        ...
        {
          "source": {
            "block": "67329754-d409-405a-80db-4f5500e5ec1b",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "027d311c-f8a6-4a4f-995c-e6d211ae9490",
