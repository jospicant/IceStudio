    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\nStart y Stop a 0 por defecto\nSi Start pasa a 1 en algún momento --> empieza la cuenta\nSi Stop pasa a 1 se para la cuenta.\nStart tiene prioridad sobre Stop --> Si Start se queda a 1 --> siempre \nestará contando.\nreset tiene la prioridad mayor de todas las entradas. Si reset=1 -->\nse resetea todo",
            "readonly": true
          },
          "position": {
            "x": 504,
