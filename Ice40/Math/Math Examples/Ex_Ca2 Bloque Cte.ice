  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3f4c1f72-a17e-4971-b5de-c70383b6e560",
          "type": "basic.constant",
          "data": {
            "name": "n",
            "value": "-156",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n El módulo de 8 bits constante acepta introducir valore negativos como por ejemplo \n el -156.\n Trabaja en Ca2 para los números negativos por lo que -156 es el Ca2 de 156 que para 8 bits\n es 100 en decimal por lo que enviará también un carácter \"d\"",
            "readonly": false
          },
          "position": {
            "x": 280,
        ...
        {
          "id": "e65988e2-c2ae-4b0e-9a9b-ff616c3c486f",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "e65988e2-c2ae-4b0e-9a9b-ff616c3c486f",
        ...
        {
          "source": {
            "block": "3f4c1f72-a17e-4971-b5de-c70383b6e560",
            "port": "constant-out"
          },
          "target": {
            "block": "e65988e2-c2ae-4b0e-9a9b-ff616c3c486f",
