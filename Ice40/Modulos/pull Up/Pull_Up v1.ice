{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "268e75f7-2d2c-487b-89a9-61430d4faea7",
          "type": "basic.input",
          "data": {
            "name": "FromPin",
            "pins": [
        ...
        {
          "id": "704b1bf3-5f13-47ff-a0b5-dab72abf7a03",
          "type": "basic.output",
          "data": {
            "name": "Pin",
            "pins": [
        ...
        {
          "id": "f57fc843-110b-4dbf-b299-6cd28d39b96b",
          "type": "basic.code",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "268e75f7-2d2c-487b-89a9-61430d4faea7",
            "port": "out"
          },
          "target": {
            "block": "f57fc843-110b-4dbf-b299-6cd28d39b96b",
            "port": "FromPin"
          }
        },
        {
          ...
          "target": {
            "block": "704b1bf3-5f13-47ff-a0b5-dab72abf7a03",
            "port": "in"
          }
        }
      ]
