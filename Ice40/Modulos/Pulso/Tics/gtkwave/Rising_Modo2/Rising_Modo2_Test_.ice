{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "19ad5059-b309-4827-89f7-b2a0c952c377",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "2968f917-3f96-4157-8cfc-3e167ae02e7f",
          "type": "basic.input",
          "data": {
            "name": "reset",
            "pins": [
        ...
        {
          "id": "441561f0-0877-456d-934f-74314a730060",
          "type": "basic.output",
          "data": {
            "name": "Rising",
            "pins": [
        ...
        {
          "id": "9376493c-0b82-4374-bf3a-dcc55b9266bc",
          "type": "basic.input",
          "data": {
            "name": "in",
            "pins": [
        ...
        {
          "id": "d11dac7a-db16-460f-ab7d-a94d6b177a80",
          "type": "be1a55d191c88e11cd0c2ed0bc49ff6c359e32c3",
          "position": {
            "x": 416,
            "y": 208
          },
      ...
      "wires": [
        {
          "source": {
            "block": "19ad5059-b309-4827-89f7-b2a0c952c377",
            "port": "out"
          },
          "target": {
            "block": "d11dac7a-db16-460f-ab7d-a94d6b177a80",
        ...
        },
        {
          ...
          "target": {
            "block": "441561f0-0877-456d-934f-74314a730060",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "2968f917-3f96-4157-8cfc-3e167ae02e7f",
            "port": "out"
          },
          "target": {
            "block": "d11dac7a-db16-460f-ab7d-a94d6b177a80",
        ...
        {
          "source": {
            "block": "9376493c-0b82-4374-bf3a-dcc55b9266bc",
            "port": "out"
          },
          "target": {
            "block": "d11dac7a-db16-460f-ab7d-a94d6b177a80",
  ...
  "dependencies": {
    "be1a55d191c88e11cd0c2ed0bc49ff6c359e32c3": {
      "package": {
        "name": "Rising",
        "version": "1.0",
        "description": "Detectar flanco de subida-Modo2",
        "author": "José Picó",
