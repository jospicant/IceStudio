  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e0e9bd9e-5edd-4c9e-98a4-d53411663306",
          "type": "basic.info",
          "data": {
            "info": "\npin -  Conecta a un pin físico de salida ( actua como inout)\noe  - habilita la dirección del dato. oe=1. El flujo del dato será saliendo por \"pin\" \n                                            \n                                            \"To_pin\" --> \"pin\"  oe=1  (salida)\n                                            \n                                      oe=0. El flujo del dato será entrando por \"pin\"\n                                            \n                                            \"pin\" ---> \"From_pin\" oe=0  (entrada)\n",
            "readonly": false
          },
          "position": {
            "x": 184,
