{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ecb54fa3-a948-4ba5-bc25-23cc016486c5",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "e69a7128-1082-4d1a-ae0a-0c771dd5de36",
          "type": "basic.input",
          "data": {
            "name": "in",
            "pins": [
        ...
        {
          "id": "8471d93e-0d31-404d-9c6d-8d32cdc5d6ec",
          "type": "basic.input",
          "data": {
            "name": "in",
            "pins": [
        ...
        {
          "id": "d0ae600b-fad0-4025-8a94-d9429182e63a",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "b1646faa-ac96-4878-b220-2e419ebffb17",
          "type": "6ca1a99c04d6586178460210e0fb4bfa5af88838",
          "position": {
            "x": 616,
            "y": 240
          },
        ...
        {
          "id": "56848a6d-fec9-4c89-bd5a-9471589ede44",
          "type": "basic.info",
          "data": {
            "info": "Nota:\n\nDO (PMOd1) siempre debe ser un PIN físico de la FPGA.\nOjo: El tener un cable pinchado en un PMODx y el otro extremo al\naire te creará un 1 lógico.",
            "readonly": false
          },
          "position": {
            "x": 360,
      ...
      "wires": [
        {
          "source": {
            "block": "b1646faa-ac96-4878-b220-2e419ebffb17",
            "port": "01c4577c-b4d4-4e37-8cda-43c12b03b0c1"
          },
          "target": {
            "block": "ecb54fa3-a948-4ba5-bc25-23cc016486c5",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "e69a7128-1082-4d1a-ae0a-0c771dd5de36",
            "port": "out"
          },
          "target": {
            "block": "b1646faa-ac96-4878-b220-2e419ebffb17",
            "port": "d9518100-331a-4ba8-b757-d0e7d86c7bc1"
          }
        },
        {
          "source": {
            "block": "8471d93e-0d31-404d-9c6d-8d32cdc5d6ec",
            "port": "out"
          },
          "target": {
            "block": "d0ae600b-fad0-4025-8a94-d9429182e63a",
            "port": "in"
          }
        }
      ]
  ...
  "dependencies": {
    "6ca1a99c04d6586178460210e0fb4bfa5af88838": {
      "package": {
        "name": "Pull_UP",
        "version": "",
        "description": "",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "d9518100-331a-4ba8-b757-d0e7d86c7bc1",
              "type": "basic.input",
              "data": {
                "name": "DO",
                "clock": false
            ...
            {
              "id": "01c4577c-b4d4-4e37-8cda-43c12b03b0c1",
              "type": "basic.output",
              "data": {
                "name": "LED0"
              },
            ...
            {
              "id": "1f8c341e-1cfb-4bc8-8447-4c05a85dea61",
              "type": "basic.code",
              "data": {
          ...
          "wires": [
            {
              "source": {
                "block": "d9518100-331a-4ba8-b757-d0e7d86c7bc1",
                "port": "out"
              },
              "target": {
                "block": "1f8c341e-1cfb-4bc8-8447-4c05a85dea61",
                "port": "DO"
              }
            },
            {
              ...
              "target": {
                "block": "01c4577c-b4d4-4e37-8cda-43c12b03b0c1",
                "port": "in"
              }
            }
          ]
