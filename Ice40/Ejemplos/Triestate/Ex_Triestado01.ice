  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "285c7fa9-0d88-4d07-b383-0913c6a5680a",
          "type": "basic.constant",
          "data": {
            "name": "sg",
            "value": "10",
        ...
        {
          "id": "34408ff8-5c7a-4cac-bf38-d5a3eed86412",
          "type": "basic.code",
          "data": {
            "code": "\n\nassign out= a ? b : 1'bz;",
            "params": [],
        ...
        {
          "id": "e065031d-30a8-43db-80ef-79b1e379a693",
        ...
        {
          "id": "ffe12e98-4780-4026-ad58-7a9313442038",
        ...
        {
          "id": "3c0a838b-07fe-4516-b697-56d315994fbf",
          "type": "basic.info",
          "data": {
            "info": "\nTriestado:                     status: Test ok\n\nSolo aplicable a pines reales de la FPGA.\nNo se puede hacer un triestado en un módulo interno que \nno tenga una conexión directa con un pin físico de la\nFPGA.",
            "readonly": false
          },
          "position": {
            "x": 352,
      ...
      "wires": [
        {
          "source": {
            "block": "34408ff8-5c7a-4cac-bf38-d5a3eed86412",
            "port": "out"
          },
          "target": {
            "block": "3836f3c8-36e1-43c3-981f-a7fbab0e9e27",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "e065031d-30a8-43db-80ef-79b1e379a693",
        ...
        {
          "source": {
            "block": "285c7fa9-0d88-4d07-b383-0913c6a5680a",
            "port": "constant-out"
          },
          "target": {
            "block": "ffe12e98-4780-4026-ad58-7a9313442038",
