  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c1d9ed0d-fc89-461b-a3ab-66f9620e57ba",
          "type": "basic.constant",
          "data": {
            "name": "Tsg",
            "value": "2",
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "\n// Q16.16 using Ca2 Q(1+15).15\n\n// El rango de números va desde -32768 a 32767.9999847.... con una precisión de 0.0000152.... (1/65536 = 1/2^16)\n// El mayor número positivo será 0111_1111_1111_1111.1111_1111_1111_1111 = 32767.9999847....   [ signo +2^15....+4+2+1 . 1/2+1/4+1/8+1/16+....1/65536]\n// El número más pequeño  será   1000_0000_0000_0000.0000_0000_0000_0000 = -32768\n// -32768 Ca2 = 32768 --> 0111_1111_1111_1111.1111_1111_1111_1111 + 1 = 0_1000_0000_0000_0000.0000_0000_0000_0000 necesito un bit más para el signo +   --> Q(1+16).16 =32768\n\n\nreg [1:0] count=0;\nreg [7:0] captura=0;\n\n\nwire [31:0] min=32'b1000_0000_0000_0000_0000_0000_0000_0000; // -32768\nwire [31:0] max=32'b0111_1111_1111_1111_1111_1111_1111_1111; //  32767.999847\n\nwire [31:0] precision;\n\nassign precision=~(min+max)+1;  // 1111_1111_1111_1111.1111_1111_1111_1111 en Ca2 --> 0000_0000_0000_0000.0000_0000_0000_0000 +1 = 0000_0000_0000_0000.0000_0000_0000_0001 = 0.0000152... de precisión\n\nalways @(posedge clk)    // tengo un contador que cuenta de 0  a 3 y en cada cuenta capturo 8 bits distintos del número de 32 bits (precisión) para poder mostrarlo con los 8 leds\nbegin\n   count<=count+1;\n   \n   case (count)\n     0: captura=precision[7:0];\n     1: captura=precision[15:8];\n     2: captura=precision[23:16];\n     3: captura=precision[31:24];\n    default captura=precision[7:0];\n   endcase\n   \nend\n\nassign o=captura;",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "a0a406c0-2362-4d46-88b7-8ffb914607fb",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a0a406c0-2362-4d46-88b7-8ffb914607fb",
        ...
        {
          "source": {
            "block": "c1d9ed0d-fc89-461b-a3ab-66f9620e57ba",
            "port": "constant-out"
          },
          "target": {
            "block": "a0a406c0-2362-4d46-88b7-8ffb914607fb",
