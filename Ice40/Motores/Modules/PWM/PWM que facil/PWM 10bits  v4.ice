{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a78d07d1-509e-44d1-840e-8f37a3735365",
          "type": "basic.input",
          "data": {
            "name": "Dutty",
            "range": "[9:0]",
        ...
        {
          "id": "3638118c-89f3-4f18-aebe-ea91d58a88de",
          "type": "eb80971cb048ab3690eb172545fcb2612367c7f7",
          "position": {
            "x": 504,
            "y": 208
          },
        ...
        {
          "id": "2c6f3788-19af-4b08-9006-77c0043c0376",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "2c6f3788-19af-4b08-9006-77c0043c0376",
        ...
        {
          "source": {
            "block": "3638118c-89f3-4f18-aebe-ea91d58a88de",
        ...
        {
          "source": {
            "block": "a78d07d1-509e-44d1-840e-8f37a3735365",
            "port": "out"
          },
          "target": {
            "block": "3638118c-89f3-4f18-aebe-ea91d58a88de",
            "port": "c8694c00-111e-4f5b-b0e6-e181a5ef8144"
          },
          "size": 10
        }
      ]
  ...
  "dependencies": {
    "eb80971cb048ab3690eb172545fcb2612367c7f7": {
      "package": {
        "name": "Counter 9bits",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "c8694c00-111e-4f5b-b0e6-e181a5ef8144",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[9:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "c8694c00-111e-4f5b-b0e6-e181a5ef8144",
                "port": "out"
              },
              "target": {
                "block": "17174045-a45c-4f73-8dd4-50651082b454",
