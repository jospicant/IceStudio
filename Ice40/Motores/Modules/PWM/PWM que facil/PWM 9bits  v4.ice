{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c97bc7b2-40da-440e-8228-19a4ed76c407",
          "type": "basic.input",
          "data": {
            "name": "Dutty",
            "range": "[8:0]",
        ...
        {
          "id": "0f07f315-c1c6-48ef-848e-82e6c7ed2d19",
          "type": "b531456901dbc709ab1199ce519fb68777738f74",
          "position": {
            "x": 160,
            "y": -224
          },
        ...
        {
          "id": "5a8a7d13-d04a-49c6-9b38-1cb78587faf2",
          "type": "1619a3f2d2c37eae318bcf3580c90882fae09d25",
          "position": {
            "x": 504,
            "y": 208
          },
        ...
        {
          "id": "c38dc819-dc0e-4389-9f0d-e36ddd08587a",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "c38dc819-dc0e-4389-9f0d-e36ddd08587a",
        ...
        {
          "source": {
            "block": "5a8a7d13-d04a-49c6-9b38-1cb78587faf2",
        ...
        {
          "source": {
            "block": "c97bc7b2-40da-440e-8228-19a4ed76c407",
            "port": "out"
          },
          "target": {
            "block": "5a8a7d13-d04a-49c6-9b38-1cb78587faf2",
            "port": "dbe29828-66a3-402d-b901-ad7c5da54c0c"
          },
          "size": 9
        }
      ]
  ...
  "dependencies": {
    "b531456901dbc709ab1199ce519fb68777738f74": {
      "package": {
        "name": "Counter 9bits",
        "version": "1.0",
        "description": "Counter",
    ...
    "1619a3f2d2c37eae318bcf3580c90882fae09d25": {
      "package": {
        "name": "Counter 9bits",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "dbe29828-66a3-402d-b901-ad7c5da54c0c",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[8:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "dbe29828-66a3-402d-b901-ad7c5da54c0c",
                "port": "out"
              },
              "target": {
                "block": "17174045-a45c-4f73-8dd4-50651082b454",
