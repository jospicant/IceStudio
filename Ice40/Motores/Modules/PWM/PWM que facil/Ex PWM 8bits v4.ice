{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "260af536-864d-4eac-a5f0-409b82a2ab6d",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "ab67fcc3-0f5a-4bcf-8048-ba4b97f7e4b5",
          "type": "basic.constant",
          "data": {
            "name": "dutty",
            "value": "1",
        ...
        {
          "id": "86630274-d278-4faf-8eb8-deaa2e3217c0",
          "type": "basic.constant",
          "data": {
            "name": "T",
            "value": "20",
        ...
        {
          "id": "152d019b-ff57-4b46-804c-eebf499fcc8c",
        ...
        {
          "id": "35748e9a-f764-4b34-8f6f-1b454e8fd629",
          "type": "basic.info",
          "data": {
            "info": "\n### Status: Checked Ok  \n T=20 ms        20ms/255 = 78,4 us por valor del dutty\n 32 = 2.5ms on;      5 = 396 us on;  \n 15 = 1.18 ms on;    1 = 79 us on;    Tiempo on = Valor de dutty * 78.4 us \n\n\n\n",
            "readonly": true
          },
          "position": {
            "x": 312,
        ...
        {
          "id": "643afb81-148c-477d-aae0-466faa3ace7a",
      ...
      "wires": [
        {
          "source": {
            "block": "643afb81-148c-477d-aae0-466faa3ace7a",
            "port": "1debc284-eb22-42ca-8b59-fa719091237d"
          },
          "target": {
            "block": "260af536-864d-4eac-a5f0-409b82a2ab6d",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "86630274-d278-4faf-8eb8-deaa2e3217c0",
            "port": "constant-out"
          },
          "target": {
            "block": "643afb81-148c-477d-aae0-466faa3ace7a",
        ...
        {
          "source": {
            "block": "152d019b-ff57-4b46-804c-eebf499fcc8c",
        ...
        {
          "source": {
            "block": "ab67fcc3-0f5a-4bcf-8048-ba4b97f7e4b5",
            "port": "constant-out"
          },
          "target": {
            "block": "152d019b-ff57-4b46-804c-eebf499fcc8c",
