{
  ...
  "design": {
    ...
    "graph": {
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "66e21b61-41d7-4e5c-bc95-3c2d2b04305b",
  ...
  "dependencies": {
    ...
    "3f25ab1a74f443e4cdc27e5874533b25fd9e0d58": {
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "2f4c8ff9-0c62-42cb-ba5f-fd379049e921",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[11:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "201979cf-b73b-4129-8559-a95fb6b1af9b",
            ...
            {
              "source": {
                "block": "2f4c8ff9-0c62-42cb-ba5f-fd379049e921",
                "port": "out"
              },
              "target": {
                "block": "201979cf-b73b-4129-8559-a95fb6b1af9b",
    ...
    "12eceda034b14398bb98eab204e87aef5c99e102": {
      "package": {
        "name": "Counter 12bits",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "c53d0779-7a90-4457-8931-4a03c0a7704d",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[11:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "c53d0779-7a90-4457-8931-4a03c0a7704d",
                "port": "out"
              },
              "target": {
                "block": "17174045-a45c-4f73-8dd4-50651082b454",
