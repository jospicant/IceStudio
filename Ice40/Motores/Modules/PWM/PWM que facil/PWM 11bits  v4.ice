{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6c785fa5-dd55-43ee-8de3-7b54a0d8b410",
          "type": "basic.input",
          "data": {
            "name": "Dutty",
            "range": "[10:0]",
        ...
        {
          "id": "8f311eea-0e09-4242-8fee-47835218d3cc",
          "type": "586472d7fdfe53f11477369ee21d70d15f6a8bf7",
          "position": {
            "x": 504,
            "y": 208
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "8f311eea-0e09-4242-8fee-47835218d3cc",
        ...
        {
          "source": {
            "block": "6c785fa5-dd55-43ee-8de3-7b54a0d8b410",
            "port": "out"
          },
          "target": {
            "block": "8f311eea-0e09-4242-8fee-47835218d3cc",
            "port": "a9b215e5-b15a-4d5c-805e-aac35f4a61d2"
          },
          "size": 11
        }
      ]
  ...
  "dependencies": {
    ...
    "586472d7fdfe53f11477369ee21d70d15f6a8bf7": {
      "package": {
        "name": "Counter 11bits",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "a9b215e5-b15a-4d5c-805e-aac35f4a61d2",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[10:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "a9b215e5-b15a-4d5c-805e-aac35f4a61d2",
                "port": "out"
              },
              "target": {
                "block": "17174045-a45c-4f73-8dd4-50651082b454",
