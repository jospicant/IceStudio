{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ad74dd7a-a13d-4bea-83ac-4c9ec086f93e",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "5f8efebd-ddd3-49b1-ae6e-1de6ab93b3a5",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "b5c58189-cec8-41ff-829d-3449fe87d96f",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "c433a850-495b-4fcd-b646-2a99adf740d9",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "67ebe390-adb8-46c7-98ca-ec3b6a7871e8",
          "type": "basic.output",
          "data": {
            "name": "M",
            "range": "[3:0]",
        ...
        {
          "id": "435759f5-c720-409c-8eed-638c7cf92e99",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "743d0f2c-0e4e-48b0-80c6-9c7aa27cd6a9",
          "type": "basic.constant",
          "data": {
            "name": "Speed",
            "value": "1",
        ...
        {
          "id": "09c039e8-c8d4-4700-9d03-a166f404c9eb",
        ...
        {
          "id": "505d627e-edce-42f9-8372-c9aa42e8ea22",
        ...
        {
          "id": "37199f20-4242-4759-b007-3b8d10d1eba4",
        ...
        {
          "id": "25e28304-d04a-4ec1-8c28-c74bfa644a9e",
        ...
        {
          "id": "016561a3-09d2-43f7-8844-d67dd9af723c",
          "type": "basic.info",
          "data": {
            "info": "\nUnipolar usando ULN2003 o similar donde el motor tendrá un cable común.\no Bipolar usando algún puente en H e intercalando bobinas para que alterne.\n",
            "readonly": false
          },
          "position": {
            "x": -144,
      ...
      "wires": [
        {
          "source": {
            "block": "743d0f2c-0e4e-48b0-80c6-9c7aa27cd6a9",
            "port": "constant-out"
          },
          "target": {
            "block": "505d627e-edce-42f9-8372-c9aa42e8ea22",
        ...
        },
        {
          ...
          "target": {
            "block": "09c039e8-c8d4-4700-9d03-a166f404c9eb",
        ...
        {
          "source": {
            "block": "435759f5-c720-409c-8eed-638c7cf92e99",
            "port": "out"
          },
          "target": {
            "block": "505d627e-edce-42f9-8372-c9aa42e8ea22",
        ...
        },
        {
          ...
          "target": {
            "block": "67ebe390-adb8-46c7-98ca-ec3b6a7871e8",
            "port": "in"
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "37199f20-4242-4759-b007-3b8d10d1eba4",
        ...
        },
        {
          ...
          "target": {
            "block": "ad74dd7a-a13d-4bea-83ac-4c9ec086f93e",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "5f8efebd-ddd3-49b1-ae6e-1de6ab93b3a5",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b5c58189-cec8-41ff-829d-3449fe87d96f",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "c433a850-495b-4fcd-b646-2a99adf740d9",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "25e28304-d04a-4ec1-8c28-c74bfa644a9e",
