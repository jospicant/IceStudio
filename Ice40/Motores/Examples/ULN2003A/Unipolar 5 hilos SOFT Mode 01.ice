{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a6494d14-06b8-4411-96a3-daba2b165e44",
          "type": "b240727927a74643c3068ff2a623cdc9358e124e",
          "position": {
            "x": 704,
            "y": 240
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a6494d14-06b8-4411-96a3-daba2b165e44",
  ...
  "dependencies": {
    ...
    "b240727927a74643c3068ff2a623cdc9358e124e": {
      "package": {
        "name": "Control 5 wires Unipolar Stepper Motor ",
        "version": "0.1",
        "description": "Control 5 wires Unipolar Stepper Motor using a soft mode control and a ULN2003A Driver pcb",
        "author": "José Picó",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "77ded513-306a-493f-a1cd-6ff705db7b61",
              "type": "03c0274af1e66931813a586cdde5c32b8f7cf959",
              "position": {
                "x": 624,
                "y": 224
              },
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "77ded513-306a-493f-a1cd-6ff705db7b61",
    ...
    "03c0274af1e66931813a586cdde5c32b8f7cf959": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "7e92405e-4f90-4d06-ac40-c0c7de0276c7",
              "type": "b0b5c25b6711e978659d8e62085e63ec28c7f628",
              "position": {
                "x": 816,
                "y": 168
              },
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "7e92405e-4f90-4d06-ac40-c0c7de0276c7",
    ...
    "b0b5c25b6711e978659d8e62085e63ec28c7f628": {
      "package": {
        "name": "Unipolar Stepper-ROM Soft Mode",
        "version": "0.2",
        "description": "Memoria ROM 4x4 para almacenar la tabla con la secuencia adecuada para el movimiento del motor paso a paso Unipolar con desplazamientos de 1 paso en modo suave (solo 1 fase está activa obteniendo menor par)",
        ...
        "graph": {
          "blocks": [
            ...
            },
            {
              ...
              "type": "basic.code",
              "data": {
                "code": "//-- Rom memory\nreg [3:0] rom [0:3]; //Rom 4 palabras de 4 bits\nwire [1:0] a;\nreg [3:0] d;\n\nalways @(negedge clk) begin\nd <= rom[a];\nend\n\n//-- Memory initialization \n//-- Secuencia para gobierno  de un\n//-- motor unipolar 5 hilos (6 hilos,8 hilos)\n//-- en Modo 1: este modo es un modo suave\n//-- se ejecuta un paso completo y solo una\n//-- bobina está activa.\n//-- queda enfrentado con la bobina activa.\n//-- No tiene gran par pero tiene menos consumo\n//-- Solo consume una bobina\n//-- Se pueden usar drivers con transistores o\n//-- como el ULN2003A..\n  initial begin\n    rom[0] = 4'b1000; \n    rom[1] = 4'b0100; \n    rom[2] = 4'b0010; \n    rom[3] = 4'b0001; \n  end\n",
                "params": [],
                "ports": {
                  "in": [
                    {
