    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "\nreg Adjust;\nreg[3:0] state=0;\n\nalways @(posedge clk)\nbegin\n    case (state)\n        0:Adjust <=16'd100;\n        1:Adjust <=16'd1000;\n        2:Adjust <=16'd5000;\n        3:Adjust <=16'd10000;\n        4:Adjust <=16'd15000;\n        5:Adjust <=16'd20000;\n        6:Adjust <=16'd25000;\n        7:Adjust <=16'd30000;\n        8:Adjust <=16'd35000;\n        9:Adjust <=16'd40000;\n        10:Adjust <=16'd45000;\n        11:Adjust <=16'd50000;\n        12:Adjust <=16'd55000;\n        13:Adjust <=16'd60000;\n        14:Adjust <=16'd61000; \n        15:Adjust <=16'd62000;\n        default: Adjust <=16'd32817;\n    endcase\n    \n    state <=state+1; //change to the next\n                     //state\nend\n\n",
            "params": [],
            "ports": {
              "in": [
                {
