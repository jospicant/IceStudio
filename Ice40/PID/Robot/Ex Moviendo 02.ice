{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "2956aca7-202c-4d56-9f14-8294af801702",
          "type": "basic.input",
          "data": {
            "name": "Izq",
            "pins": [
        ...
        {
          "id": "481f625d-8ba8-40dd-8302-bbeecf46ecc3",
          "type": "basic.input",
          "data": {
            "name": "Dcha",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\nTest de 2 Motores pap 28BYJ-48 + PCBs con ULN2003\nAlimento con los 3.3v del la Icestick )\n\nMotor 1 en TRx\nMotor 2 en BRx\n\nAl alimentar a 5 V pe ha permitido mayor frecuencia que a\n3.3 V.",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "31fc082e-59f9-4088-9a5b-1393eae148ce",
          "type": "e22619150c976467c22208c286a89a943e636b7a",
          "position": {
            "x": 360,
            "y": 264
          },
        ...
        {
          "id": "809105cd-a9ac-4bb1-8245-b89657686e4a",
          "type": "3485fc6cf753eb89a210aa2dc1153c2e89eda395",
          "position": {
            "x": 8,
            "y": 392
          },
        ...
        {
          "id": "53e17bc7-9fd1-4524-ab58-928bfccc265e",
          "type": "e22619150c976467c22208c286a89a943e636b7a",
          "position": {
            "x": 344,
            "y": 480
        ...
        {
          "id": "5741c15c-5bed-4a2a-8c38-08afe8e6ea72",
          "type": "3485fc6cf753eb89a210aa2dc1153c2e89eda395",
          "position": {
            "x": 0,
            "y": 544
        ...
        {
          "id": "ed1cc42b-393e-4f89-9fc8-d25e9324cc76",
          "type": "basic.info",
          "data": {
            "info": "Biestable D con reset para\nparar movimiento de la otra rueda durante los giros",
            "readonly": true
          },
          "position": {
            "x": 88,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "809105cd-a9ac-4bb1-8245-b89657686e4a",
            "port": "716d8c32-bc72-4468-a249-dd1a6e27c7c8"
          },
          "target": {
            "block": "aed225c9-1556-475f-9599-274325fdc624",
        ...
        {
          "source": {
            "block": "5741c15c-5bed-4a2a-8c38-08afe8e6ea72",
            "port": "e9e70da1-0bca-494f-b452-c3156ac875d2"
          },
          "target": {
            "block": "b4bb402a-9c66-4aa2-a273-2ee70ce98ba5",
            "port": "5709a889-120d-43fa-bc1b-0bcaf7a29746"
        ...
        {
          "source": {
            "block": "2956aca7-202c-4d56-9f14-8294af801702",
            "port": "out"
          },
          "target": {
            "block": "809105cd-a9ac-4bb1-8245-b89657686e4a",
            "port": "bb363b61-8f2d-40b8-a1e5-c98a14ea3593"
          }
        },
        {
          "source": {
            "block": "481f625d-8ba8-40dd-8302-bbeecf46ecc3",
            "port": "out"
          },
          "target": {
            "block": "5741c15c-5bed-4a2a-8c38-08afe8e6ea72",
        ...
        },
        {
          ...
          "target": {
            "block": "31fc082e-59f9-4088-9a5b-1393eae148ce",
        ...
        },
        {
          ...
          "target": {
            "block": "31fc082e-59f9-4088-9a5b-1393eae148ce",
            "port": "919c4eac-5c35-46c0-a3f3-209ea9d81b42"
          }
        },
        {
          "source": {
          ...
          "target": {
            "block": "53e17bc7-9fd1-4524-ab58-928bfccc265e",
            "port": "f5b0fa41-3141-4216-a31a-770bc5866f59"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    ...
    "e22619150c976467c22208c286a89a943e636b7a": {
      "package": {
        "name": "Biestable D",
        "version": "v1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "919c4eac-5c35-46c0-a3f3-209ea9d81b42",
              "type": "basic.input",
              "data": {
                "name": "rs",
                "clock": false
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "919c4eac-5c35-46c0-a3f3-209ea9d81b42",
                "port": "out"
              },
              "target": {
                "block": "099db605-2cf8-4928-9e98-0ebe4460dd20",
    ...
    "3485fc6cf753eb89a210aa2dc1153c2e89eda395": {
      "package": {
        "name": "TCRT5000",
        "version": "1.0",
