  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "76f7e568-d8f2-452a-b198-b8bda4004e22",
          "type": "basic.info",
          "data": {
            "info": "Las señales de cuadratura QA,QB se suponen que son señales que no están sincronizadas con la señal de reloj por lo que se \nañade un módulo \"sinc v1.0\" que simplemente son dos biestables en serie que harán que se sincronicen las señales con la señal de \"clk\"\nLuego se usa un biestable más para cada señal de cuadratura para comparar señales de cuadratura entre ellas y con ellas mismas en el \nestado actual y anterior de forma que se pueda averiguar la dirección y crear también una señal de habilitación.\n\n",
            "readonly": false
          },
          "position": {
            "x": 104,
