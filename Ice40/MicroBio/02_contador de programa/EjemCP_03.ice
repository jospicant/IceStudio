  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "cb1c7a28-4e21-49a6-acf1-0e329c57487c",
          "type": "basic.input",
          "data": {
            "name": "in",
            "pins": [
        ...
        {
          "id": "8d7c161a-aff8-4f03-b8b9-11b73c9d3a67",
          "type": "basic.constant",
          "data": {
            "name": "Paro",
            "value": "10",
        ...
        {
          "id": "4203a27c-dc28-4530-a6b7-c12462eb8d11",
          "type": "basic.constant",
          "data": {
            "name": "Carga",
            "value": "20",
        ...
        {
          "id": "c5d8d8b5-72cf-4cf3-a1ea-91dacc64e2df",
        ...
        {
          "id": "2e01b75a-e7f3-41c0-b059-f49417e24c14",
          "type": "1ea7084dd5e3bb0384a97cd2cb06a373ccb263e8",
          "position": {
            "x": -336,
            "y": 512
        ...
        {
          "id": "2fb6b4ed-d394-4321-b807-414b44fb57ef",
          "type": "basic.info",
          "data": {
            "info": "\nDurante 5 sg el Contador de programa se incrementa normal, cp_inc=1  \nDurante otros 5 sg el Contador del programa se para cp_inc=0  \nDurante otros 10 sg cp_load=1 y se carga la dirección 14 (valor FF de Prog.list)  \ny vuelta a empezar.  ",
            "readonly": true
          },
          "position": {
            "x": -464,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "8d7c161a-aff8-4f03-b8b9-11b73c9d3a67",
            "port": "constant-out"
          },
          "target": {
            "block": "c5d8d8b5-72cf-4cf3-a1ea-91dacc64e2df",
            "port": "63eb4dd8-1e63-4a4f-8ec8-f5d8f49c1087"
          }
        },
        {
          "source": {
            "block": "cb1c7a28-4e21-49a6-acf1-0e329c57487c",
            "port": "out"
          },
          "target": {
            "block": "c5d8d8b5-72cf-4cf3-a1ea-91dacc64e2df",
        ...
        },
        {
          ...
          "target": {
            "block": "2e01b75a-e7f3-41c0-b059-f49417e24c14",
            "port": "fabd9c4f-a3bf-43e1-86c1-be5bf602e9bf"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "4203a27c-dc28-4530-a6b7-c12462eb8d11",
            "port": "constant-out"
          },
          "target": {
            "block": "2e01b75a-e7f3-41c0-b059-f49417e24c14",
