{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e77264f5-574d-4983-8075-6436c86a5761",
          "type": "basic.info",
          "data": {
            "info": "\nUsando ULN2003 y Motor 28BYJ-48 5V.\n100 Hz = 3 rpm aprox; 200 Hz = 6 rpm aprox;\nFunciona a un Max de 550 Hz tras pruebas.\n",
            "readonly": false
          },
          "position": {
            "x": 72,
        ...
        {
          "id": "f3b6f488-cd9f-4d4f-8dc6-3d1b15e5454f",
          "type": "basic.info",
          "data": {
            "info": "\nSpeed: nos marcará la velocidad de rotación del motor pap\nDirection: 0 o 1 nos configurará el sentido de giro\nStepper[3:0]: 4 hilos de salida para atacar motor pap bipolar\n(lo normal es que ataque a un driver de potencia).",
            "readonly": false
          },
          "position": {
            "x": 344,
        ...
        {
          "id": "0f102187-03b2-4703-8219-65ab749d7de6",
          "type": "basic.info",
          "data": {
            "info": "\nBiestable T para cambiar\nsentido cada 10 sg",
            "readonly": false
          },
          "position": {
            "x": 528,
